...
* **Replication Scope**: Implementation and evaluation of Persistence Landscape $L^1$ and $L^2$ norms for detecting phase transitions and market crashes in financial time series. The full reproduction notebook can be found at `reproductions/gidea_katz_2018/reproduction_landscapes_of_crashes.ipynb`.
